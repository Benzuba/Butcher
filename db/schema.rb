...
ActiveRecord::Schema.define(version: 20_161_201_150_840) do
  ...
  add_index 'enrollments', %w(user_id course_id), name: 'index_enrollments_on_user_id_and_course_id', using: :btree
